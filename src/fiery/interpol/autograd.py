...
try:
    ...
    try:
        from torch.cuda.amp import custom_bwd as _custom_bwd_cuda
        from torch.cuda.amp import custom_fwd as _custom_fwd_cuda
    except (ModuleNotFoundError, ImportError):
        _custom_fwd_cuda = _custom_bwd_cuda = fake_decorator

    try:
        from torch.cpu.amp import custom_bwd as _custom_bwd_cpu
        from torch.cpu.amp import custom_fwd as _custom_fwd_cpu
    except (ModuleNotFoundError, ImportError):
